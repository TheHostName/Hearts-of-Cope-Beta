...
NDefines.NDiplomacy.EMBARGO_THREAT_THRESHOLD = 10						-- Target-generated threat threshold to allow embargo (affected by modifiers)
NDefines.NDiplomacy.EMBARGO_NEIGHBOUR_AI_WEIGHT = -100
NDefines.NDiplomacy.BASE_IMPROVE_RELATION_COST = 0                -- Political power cost to initiate relation improvement
NDefines.NDiplomacy.BASE_IMPROVE_RELATION_SAME_IDEOLOGY_GROUP_MAINTAIN_COST = 0.1 -- Political power cost each update when boosting relations with nation of same ideology
NDefines.NDiplomacy.BASE_IMPROVE_RELATION_DIFFERENT_IDEOLOGY_GROUP_MAINTAIN_COST = 0    -- Political power cost each update when boosting relations with nation of different ideology
NDefines.NDiplomacy.EMBARGO_COST = 100										-- One-time cost
---AI
...
NDefines.NAI.ACCESS_SCORE_PENALTY_PER_EXISTING_ACCESS_AT_WAR = 0		-- each access reduces the desire of next access
NDefines.NAI.ACCESS_SCORE_PENALTY_PER_EXISTING_ACCESS = 0				-- each access reduces the desire of next access
NDefines.NAI.BASE_RELUCTANCE = 9
NDefines.NAI.NAVAL_STRIKE_PLANES_PER_SHIP = 40				-- Amount of bombers requested per enemy ship
NDefines.NAI.PORT_STRIKE_PLANES_PER_SHIP = 30					-- Amount of bombers request per enemy ship in the port
...
NDefines.NGame.COMBAT_LOG_MAX_MONTHS = 96
NDefines.NGame.END_DATE = "1956.1.1.1" -- we are called r56 for a reason!
NDefines.NGame.GAME_SPEED_SECONDS = { 600.0, 0.45 , 0.25, 0.18, 0.0 }

-- Production
NDefines.NProduction.CAPITAL_SHIP_MAX_NAV_FACTORIES_PER_LINE = 40
NDefines.NProduction.DEFAULT_MAX_NAV_FACTORIES_PER_LINE = 40
NDefines.NProduction.BASE_NAVAL_EQUIPMENT_CONVERSION_IC_COST_FACTOR = 0.00
NDefines.NProduction.CONVOY_MAX_NAV_FACTORIES_PER_LINE = 10
...
NDefines.NMilitary.LAND_COMBAT_STR_DAMAGE_MODIFIER = 0.070       -- global damage modifier... but some equipment is returned at end of battles see : EQUIPMENT_COMBAT_LOSS_FACTOR
NDefines.NMilitary.LAND_COMBAT_ORG_DAMAGE_MODIFIER = 0.043       -- global damage modifier
NDefines.NMilitary.LAND_AIR_COMBAT_STR_DAMAGE_MODIFIER = 0.042   -- air global damage modifier
NDefines.NMilitary.LAND_AIR_COMBAT_ORG_DAMAGE_MODIFIER = 0.042   -- global damage modifier
...
NDefines.NMilitary.LAND_COMBAT_ORG_ARMOR_ON_SOFT_DICE_SIZE = 4
...
NDefines.NMilitary.CHANCE_TO_AVOID_HIT_AT_NO_DEF = 70	           -- chance to avoid hit if no defences left.
...
NDefines.NMilitary.RECON_SKILL_IMPACT = 4
...
NDefines.NAir.NAVAL_STRIKE_DAMAGE_TO_STR = 1.5					-- Balancing value to convert damage ( naval_strike_attack * hits ) to Strength reduction.
...
NDefines.NAir.NAVAL_STRIKE_CARRIER_MULTIPLIER = 3.3             -- damage bonus when planes are in naval combat where their carrier is present (and can thus sortie faster and more effectively)
...
NDefines.NNavy.SUPREMACY_PER_SHIP_BASE = 0
...
NDefines.NNavy.SUPREMACY_PER_SHIP_BASE = 0
-- Supply
NDefines.NSupply.NODE_INITIAL_SUPPLY_FLOW = 3.4
NDefines.NSupply.NODE_STARTING_PENALTY_PER_PROVINCE = 0.50
NDefines.NSupply.NODE_ADDED_PENALTY_PER_PROVINCE = 0.7
NDefines.NSupply.SUPPLY_HUB_FULL_MOTORIZATION_BONUS = 2.2-- 2.2
NDefines.NSupply.SUPPLY_HUB_FULL_MOTORIZATION_TRUCK_COST = 100

NDefines.NSupply.NAVAL_BASE_INITIAL_SUPPLY_FLOW = 3.3
NDefines.NSupply.NAVAL_BASE_STARTING_PENALTY_PER_PROVINCE = 0.80
